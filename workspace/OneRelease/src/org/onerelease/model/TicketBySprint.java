...
@Entity
@Views({@View(members="milestone, status; sprint ; collaborator ; ticket")
,@View(name="ticketBySprintUnderSprint",extendsView="DEFAULT"),@View(name="TicketBySprintUnderTicket", members="milestone, "
		+ "status, sprint, collaborator" )})
...
public class TicketBySprint extends Identifiable {
	...
	@DefaultValueCalculator(value=TicketBySprintStatusCalculator.class)
	private TicketBySprintStatus status = TicketBySprintStatus.initiated; 
...
//	@ReferenceView("CollaboratorUnderTicketBySprint")
	...
	@ManyToOne(optional = false, fetch = FetchType.LAZY)
	@ReferenceView(value="TicketUnderSprint")
