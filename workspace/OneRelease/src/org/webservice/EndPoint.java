...
//			logger.info("helllooooo");
			...
			if(ticket.getRank() == null) ticket.setRank(newRank);
//	        ticket.setJiraId(webhook.getIssue().getId());
	        ...
	        if(webhook.getIssue().getFields().getIssuetype().getName().equals(IssueType.ISSUE_TYPE_EPIC))
	        		{
