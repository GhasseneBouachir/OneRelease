...
// */
//
//function DiagramEditor(resultId,config, ui, done)
//{
...
// */
//DiagramEditor.editElement = function(elt, resultId, config, ui, done)
//{
//	return new DiagramEditor(resultId,config, ui, done).editElement(elt);
//};
//
///**
...
// */
//DiagramEditor.prototype.frameStyle = 'position:fixed; top:0; left:0; bottom:0; right:0;	width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;';
//
///**
// * resultId is the id of the input text
// */
//DiagramEditor.prototype.resultId = null;
//
///**
...
//		//Modification of input value to store the new diagram edition
//		let input = document.getElementById(this.resultId);
